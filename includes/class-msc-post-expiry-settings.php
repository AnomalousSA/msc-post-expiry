...
class MSC_Post_Expiry_Settings {
    ...
    public static function render_landing_page() {
        echo '<div class="wrap">';
        echo '<h1>' . esc_html__( 'Site Care', 'msc-post-expiry' ) . '</h1>';
            ...
            <form method="post" action="">
                ...
                <table class="form-table" role="presentation">
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="mscpe[default_action]">
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="mscpe[archive_category]">
                ...
                <?php submit_button( __( 'Save Settings', 'msc-post-expiry' ), 'primary', 'mscpe_settings_submit' ); ?>
            </form>
        </div>
        <?php
    }
...
if ( ! function_exists( 'msc_render_combined_upgrade_page' ) ) {
    function msc_render_combined_upgrade_page() {
        ...
        echo '<div class="wrap">';
        echo '<h1>' . esc_html__( 'Upgrade to Pro', 'msc-post-expiry' ) . '</h1>';
        echo '<p>' . esc_html__( 'Upgrade individual modules to unlock more features for each plugin.', 'msc-post-expiry' ) . '</p>';
        if ( empty( $sections ) ) {
            echo '<p>' . esc_html__( 'No upgrades available.', 'msc-post-expiry' ) . '</p>';
        } else {
